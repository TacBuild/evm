...
type TacSimulateRequest struct {
	...
	// proposer_address of the requested block in hex format
	ProposerAddress github_com_cosmos_cosmos_sdk_types.ConsAddress `protobuf:"bytes,5,opt,name=proposer_address,json=proposerAddress,proto3,casttype=github.com/cosmos/cosmos-sdk/types.ConsAddress" json:"proposer_address,omitempty"`
	// chain_id is the eip155 chain id parsed from the requested block header
	ChainId int64 `protobuf:"varint,6,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
}

func (m *TacSimulateRequest) Reset()         { *m = TacSimulateRequest{} }
func (m *TacSimulateRequest) String() string { return proto.CompactTextString(m) }
...
func (m *TacSimulateRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TacSimulateRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TacSimulateRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TacSimulateRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TacSimulateRequest.Merge(m, src)
}
func (m *TacSimulateRequest) XXX_Size() int {
	return m.Size()
}
func (m *TacSimulateRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TacSimulateRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TacSimulateRequest proto.InternalMessageInfo

func (m *TacSimulateRequest) GetArgs() []byte {
	if m != nil {
		return m.Args
	}
	return nil
...
func (m *TacSimulateRequest) GetStateOverride() []byte {
	if m != nil {
		return m.StateOverride
	}
	return nil
}

func (m *TacSimulateRequest) GetBlockOverrides() []byte {
	if m != nil {
...
func (m *TacSimulateRequest) GetGasCap() uint64 {
	if m != nil {
		return m.GasCap
	}
	return 0
...
func (m *TacSimulateRequest) GetChainId() int64 {
	if m != nil {
		return m.ChainId
	}
	return 0
...
func (m *TacSimulateResponse) Reset()         { *m = TacSimulateResponse{} }
func (m *TacSimulateResponse) String() string { return proto.CompactTextString(m) }
...
func (m *TacSimulateResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TacSimulateResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TacSimulateResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TacSimulateResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TacSimulateResponse.Merge(m, src)
}
func (m *TacSimulateResponse) XXX_Size() int {
	return m.Size()
}
func (m *TacSimulateResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_TacSimulateResponse.DiscardUnknown(m)
}

var xxx_messageInfo_TacSimulateResponse proto.InternalMessageInfo

func (m *TacSimulateResponse) GetHash() string {
	if m != nil {
		return m.Hash
	}
	return ""
...
func (m *TacSimulateResponse) GetLogs() []*Log {
	if m != nil {
		return m.Logs
	}
	return nil
...
func (m *TacSimulateResponse) GetRet() []byte {
	if m != nil {
		return m.Ret
	}
	return nil
...
func (m *TacSimulateResponse) GetVmError() string {
	if m != nil {
		return m.VmError
	}
	return ""
...
func (m *TacSimulateResponse) GetGasUsed() uint64 {
	if m != nil {
		return m.GasUsed
	}
	return 0
...
func (m *TacSimulateResponse) GetGasEstimated() uint64 {
	if m != nil {
...
func (m *QueryTraceCallRequest) GetStateOverride() []byte {
	if m != nil {
		return m.StateOverride
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TacSimulateRequest)(nil), "cosmos.evm.vm.v1.TacSimulateRequest")
	proto.RegisterType((*TacSimulateResponse)(nil), "cosmos.evm.vm.v1.TacSimulateResponse")
...
var fileDescriptor_0e8f08e175b3ef0c = []byte{
	...
	,
}
...
func (c *queryClient) TacSimulate(ctx context.Context, in *TacSimulateRequest, opts ...grpc.CallOption) (*TacSimulateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.evm.vm.v1.Query/TacSimulate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) TacSimulate(ctx context.Context, req *TacSimulateRequest) (*TacSimulateResponse, error) {
...
func _Query_TacSimulate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.evm.vm.v1.Query/TacSimulate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *TacSimulateRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TacSimulateRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TacSimulateRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.StateOverride) > 0 {
		i -= len(m.StateOverride)
		copy(dAtA[i:], m.StateOverride)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.StateOverride)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Args) > 0 {
...
func (m *TacSimulateResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TacSimulateResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TacSimulateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.GasEstimated != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.GasEstimated))
		i--
		dAtA[i] = 0x30
	}
	if m.GasUsed != 0 {
...
func (m *TacSimulateRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TacSimulateResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.GasEstimated != 0 {
		n += 1 + sovQuery(uint64(m.GasEstimated))
	}
	return n
}
...
func (m *TacSimulateRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TacSimulateRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TacSimulateRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StateOverride", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StateOverride = append(m.StateOverride[:0], dAtA[iNdEx:postIndex]...)
			if m.StateOverride == nil {
				m.StateOverride = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *TacSimulateResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TacSimulateResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TacSimulateResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GasEstimated |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
