...
func (ValidatorStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8986499a0b409e33, []int{0}
}
...
type UpdatableParams struct {
	// UnstakeFeeRate specifies the fee rate when liquid unstake is requested,
	// unbonded by subtracting it from unbondingAmount
	UnstakeFeeRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=unstake_fee_rate,json=unstakeFeeRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"unstake_fee_rate"`
	// LsmDisabled allows to block any msgs that convert staked tokens into
	// gTAC through LSM.
	...
	// to the active liquid validators on liquid staking to minimize decimal loss
	// and consider gas efficiency.
	MinLiquidStakeAmount cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=min_liquid_stake_amount,json=minLiquidStakeAmount,proto3,customtype=cosmossdk.io/math.Int" json:"min_liquid_stake_amount"`
	// CwLockedPoolAddress defines the bech32-encoded address of
	// a CW smart-contract representing a time locked LP (e.g. Superfluid LP).
...
func (m *UpdatableParams) Reset()      { *m = UpdatableParams{} }
func (*UpdatableParams) ProtoMessage() {}
func (*UpdatableParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_8986499a0b409e33, []int{1}
}
func (m *UpdatableParams) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdatableParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdatableParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdatableParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdatableParams.Merge(m, src)
}
func (m *UpdatableParams) XXX_Size() int {
	return m.Size()
}
func (m *UpdatableParams) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdatableParams.DiscardUnknown(m)
}

var xxx_messageInfo_UpdatableParams proto.InternalMessageInfo
...
func (*WhitelistedValidator) Descriptor() ([]byte, []int) {
	return fileDescriptor_8986499a0b409e33, []int{2}
}
...
func (*LiquidValidator) Descriptor() ([]byte, []int) {
	return fileDescriptor_8986499a0b409e33, []int{3}
}
...
func (*LiquidValidatorState) Descriptor() ([]byte, []int) {
	return fileDescriptor_8986499a0b409e33, []int{4}
}
...
type NetAmountState struct {
	...
	GtacTotalSupply cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=gtac_total_supply,json=gtacTotalSupply,proto3,customtype=cosmossdk.io/math.Int" json:"gtac_total_supply"`
...
func (*NetAmountState) Descriptor() ([]byte, []int) {
	return fileDescriptor_8986499a0b409e33, []int{5}
}
...
func init() {
	proto.RegisterEnum("tac.liquidstake.v1beta1.ValidatorStatus", ValidatorStatus_name, ValidatorStatus_value)
	proto.RegisterType((*Params)(nil), "tac.liquidstake.v1beta1.Params")
	proto.RegisterType((*UpdatableParams)(nil), "tac.liquidstake.v1beta1.UpdatableParams")
	proto.RegisterType((*WhitelistedValidator)(nil), "tac.liquidstake.v1beta1.WhitelistedValidator")
	proto.RegisterType((*LiquidValidator)(nil), "tac.liquidstake.v1beta1.LiquidValidator")
	proto.RegisterType((*LiquidValidatorState)(nil), "tac.liquidstake.v1beta1.LiquidValidatorState")
	proto.RegisterType((*NetAmountState)(nil), "tac.liquidstake.v1beta1.NetAmountState")
}

func init() {
	proto.RegisterFile("tac/liquidstake/v1beta1/liquidstake.proto", fileDescriptor_8986499a0b409e33)
}

var fileDescriptor_8986499a0b409e33 = []byte{
	// 1030 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *UpdatableParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdatableParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdatableParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *NetAmountState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1a
	{
		size := m.GtacTotalSupply.Size()
		i -= size
		if _, err := m.GtacTotalSupply.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintLiquidstake(dAtA, i, uint64(size))
	}
...
func (m *UpdatableParams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdatableParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdatableParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdatableParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *NetAmountState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.GtacTotalSupply.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
